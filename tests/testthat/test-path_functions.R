...
test_that("get_abs_paths() works as expected", {
  ...
  expect_true(endsWith(paths$country_concordance_path, file.path("Country_Concordance_Full.xlsx")))

  # Aggregation mapping path
  expect_true(endsWith(paths$aggregation_mapping_path, file.path("aggregation_mapping.xlsx")))

  # exemplar table path
  expect_true(endsWith(paths$exemplar_table_path, file.path("Exemplar_Table.xlsx")))

  # phi constants table path
  expect_true(endsWith(paths$phi_constants_path, file.path("phi_constants.xlsx")))
